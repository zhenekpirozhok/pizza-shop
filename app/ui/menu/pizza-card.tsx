...
export const PizzaCard = ({ pizza }: { pizza: Pizza }) => {
  ...
  return (
    <div className="relative flex flex-col items-center text-center shadow-md p-4 rounded-xl border-1 border-red-600">
      ...
      <button onClick={() => addToCart(pizza)} className="bg-red-800 hover:bg-red-900 text-white shadow-md py-2 px-4 rounded-full cursor-pointer text-sm uppercase mt-4">
        + Add to cart
      </button>
    </div>
  );
